...
const testimonials = [
  ...
  { name: "Elena R.", role: "Expert", initials: "ER", content: "As a graphic designer, Druxio fills my downtime perfectly. Quick jobs, instant payment, no negotiations.", rating: 5, category: "Creative", timeAgo: "3 days ago" },
