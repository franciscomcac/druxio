...
const Header = () => {
  ...
  return (
    <header className="lg:fixed lg:top-0 lg:left-0 sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-xl" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
