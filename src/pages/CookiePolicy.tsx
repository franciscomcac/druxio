    ...
    <main className="min-h-screen py-16">
      <div className="container mx-auto max-w-3xl px-4">
        ...
        <Section title="3. Third-Party Cookies">
          ...
          <p><strong className="text-foreground">PayPal</strong> — payment processing. See <a href="https://www.paypal.com/webapps/mpp/ua/cookie-full" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-4">PayPal's Cookie Policy</a>.</p>
