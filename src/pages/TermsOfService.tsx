    ...
    <main className="min-h-screen py-16">
      <div className="container mx-auto max-w-3xl px-4">
        ...
        <Section title="6. Payments & Escrow">
          <p>Clients fund Escrow via PayPal at the time of quote acceptance. Druxio holds these funds until the Order is marked as delivered and confirmed by the Client, or until the auto-release window expires.</p>
