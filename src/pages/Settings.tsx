...
const CATEGORY_TREE = [
  {
    ...
    subs: [
      ...
      { id: "Roblox", services: ["Scripting", "Building", "Game Dev", "UI Design", "Account Services"] },
      { id: "GTA", services: ["Money Grinding", "Heists", "Modding Help", "RP Setup", "Account Recovery"] },
      { id: "Overwatch", services: ["Boosting", "Coaching", "VOD Review", "Carry / Duo"] },
      { id: "Rocket League", services: ["Boosting", "Coaching", "Training Packs", "Carry / Duo"] },
      { id: "Dota 2", services: ["Boosting", "Coaching", "VOD Review", "Carry / Duo"] },
      { id: "FIFA", services: ["Coaching", "Squad Building", "Trading Tips", "FUT Champions"] },
      { id: "COD", services: ["Boosting", "Coaching", "Camo Grinding", "Carry / Duo"] },
      { id: "Rust", services: ["Coaching", "Base Design", "Raid Help", "Carry / Duo"] },
      { id: "Escape from Tarkov", services: ["Coaching", "Carry", "Quest Help", "Loot Runs"] },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "AI & Automation", services: ["Chatbot Setup", "Workflow Automation", "AI Integration", "Prompt Engineering"] },
      { id: "Cybersecurity", services: ["Security Audit", "Penetration Testing", "Malware Removal", "Hardening"] },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "Analytics & Data", services: ["Dashboard Setup", "Data Analysis", "Reporting", "BI Tools"] },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "Photography", services: ["Photo Editing", "Product Photos", "Portrait Retouching", "Compositing"] },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "Piano Lessons", services: ["Beginner", "Intermediate", "Advanced", "Music Theory"] },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "Yoga & Mobility", services: ["Beginner Yoga", "Advanced Yoga", "Stretching", "Recovery"] },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "French", services: ["Conversation", "Grammar", "DELF Prep"] },
      { id: "German", services: ["Conversation", "Grammar", "Goethe Prep"] },
      { id: "Portuguese", services: ["Conversation", "Grammar", "CELPE-Bras Prep"] },
      { id: "Arabic", services: ["Conversation", "Grammar", "MSA", "Dialect"] },
      { id: "Chinese", services: ["Conversation", "Grammar", "HSK Prep", "Business Chinese"] },
      { id: "Japanese", services: ["Conversation", "Grammar", "JLPT Prep", "Business Japanese"] },
      { id: "Korean", services: ["Conversation", "Grammar", "TOPIK Prep"] },
      { id: "Italian", services: ["Conversation", "Grammar", "CILS Prep"] },
      { id: "Russian", services: ["Conversation", "Grammar", "TORFL Prep"] },
      { id: "Hindi", services: ["Conversation", "Grammar", "Reading & Writing"] },
  ...
  },
  {
    ...
    subs: [
      ...
      { id: "Instagram", services: ["Content Strategy", "Reels Editing", "Growth", "Aesthetics"] },
