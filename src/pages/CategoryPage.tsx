...
const CATEGORY_META: Record<string, { label: string; icon: any; description: string; seoDescription: string; subcategories: string[] }> = {
  gaming: { label: "Gaming", icon: Gamepad2, description: "Boosting, coaching & game expertise", seoDescription: "Find gaming coaches and boosting services on Druxio. Verified experts for Valorant, Arc Raiders, Fortnite, CS2 and more.", subcategories: ["Valorant", "Arc Raiders", "Fortnite", "Minecraft", "CS2", "Apex Legends", "League of Legends"] },
  ...
  creative: { label: "Creative", icon: Palette, description: "Design, video editing & copywriting", seoDescription: "Hire freelance designers, video editors, and copywriters at the lowest marketplace fees. Logo design, thumbnails, ad copy and more on Druxio.", subcategories: ["Graphic Design", "Video Editing", "Ad Copy", "Thumbnails"] },
  music: { label: "Music", icon: Music, description: "Production, mixing & lessons", seoDescription: "Find music producers, mixing engineers, and music tutors on Druxio. Affordable rates with escrow-protected payments.", subcategories: ["Production", "Mixing & Mastering", "Guitar Lessons"] },
  fitness: { label: "Fitness", icon: Dumbbell, description: "Training & nutrition plans", seoDescription: "Connect with personal trainers and nutritionists instantly on Druxio. Get custom plans and expert coaching at low fees.", subcategories: ["Personal Training", "Nutrition Plans"] },
  languages: { label: "Languages", icon: Globe, description: "Tutoring & translation", seoDescription: "Find language tutors and translators on Druxio. Affordable English, Spanish, and multilingual services with real-time quotes.", subcategories: ["English", "Spanish"] },
  content: { label: "Content", icon: Video, description: "Streaming, YouTube & TikTok", seoDescription: "Hire content creators, YouTube editors, and TikTok strategists with low marketplace fees. Grow your channel with verified experts on Druxio.", subcategories: ["Streaming", "YouTube", "TikTok"] },
};
    ...
    jsonLd: meta ? [
      {
        ...
        "url": `https://druxio.net/category/${slug}`,
        "numberOfItems": meta.subcategories.length,
        "itemListElement": meta.subcategories.map((sub, i) => ({
          "@type": "ListItem",
          "position": i + 1,
          "name": sub,
          "url": `https://druxio.net/post-request?category=${meta.label}: ${sub}`,
        })),
      },
      {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://druxio.net/" },
          { "@type": "ListItem", "position": 2, "name": meta.label, "item": `https://druxio.net/category/${slug}` },
        ],
      },
    ] : undefined,
  });
