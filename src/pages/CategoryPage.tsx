...
const CATEGORY_META: Record<string, { label: string; icon: any; description: string; seoDescription: string; subcategories: string[] }> = {
  gaming: { label: "Gaming", icon: Gamepad2, description: "Boosting, coaching & game expertise", seoDescription: "Find gaming coaches and boosting services on Druxio. Verified experts for Valorant, Fortnite, CS2 and more.", subcategories: ["Valorant", "Fortnite", "Minecraft", "CS2", "Apex Legends", "League of Legends"] },
